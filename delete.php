...
<?php
echo'<tr>
<td> <a href=id_delete.php?id='.$id.'><i class="fa-solid fa-trash"></i>DELETE</a> <a href=homepage.php.php style="float:right;" ><h6 style="color: #000;"><i class="fa-solid fa-house"></i>GO HOME</h6></a></td>
</tr>';
?></div>
